 ...
 * @author C0160
 */
public class SalesOrderTonSZYW extends SalesOrderTon {

    public SalesOrderTonSZYW() {
        super();
        queryParams.put("facno", "H");
        queryParams.put("cusno", " ='HJS00010' ");
    }
    ...
    public BigDecimal getNotDelivery(Date d, LinkedHashMap<String, Object> map) {
        ...
        queryParams.put("cusno", " ='YJS00004' ");
