...
/**
 *
 * @author C1749 汉声预估订单量（金额）
 */
public abstract class ShipmentPredictAmts extends Shipment {

    public ShipmentPredictAmts() {
        super();
    }
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        sb.append(" select h.cdrno,h.decode,h.recdate,left(convert(char(12),h.recdate,112),6) as yearmon,h.ratio,d.itnbr, ");
