...
@Stateless
@LocalBean
public class HYShipmentMailBean extends ShipmentMail {
    ...
    protected String getShipementTonTable() {
        ...
        try {
            ...
            indicators.clear();
            indicators = indicatorBean.findByCategoryAndYear("汉扬依材质别出货重量", y);
            indicatorBean.getEntityManager().clear();
            if (indicators != null && !indicators.isEmpty()) {
                for (Indicator i : indicators) {
                    indicatorBean.divideByRate(i, 2);
    ...
    protected String getShipementAmountTable() {
        ...
        try {
            ...
            indicators.clear();
            indicators = indicatorBean.findByCategoryAndYear("汉扬依材质别出货金额", y);
            indicatorBean.getEntityManager().clear();
            if (indicators != null && !indicators.isEmpty()) {
                for (Indicator i : indicators) {
                    indicatorBean.divideByRate(i, 2);
