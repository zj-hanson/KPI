 ...
 * @author C1879
 */
public class FreeServiceOuterSum1U extends FreeServiceERP{

    IndicatorBean indicatorBean = lookupIndicatorBean();

    public FreeServiceOuterSum1U() {
        super();
        queryParams.put("formid", "A-涡旋服务成本");
   ...
   //差旅费+运费+服务领退料
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceOuterSum1U.class.getName()).log(Level.SEVERE, null, ex);
        }
