 ...
 * @author C1879
 */
public class FreeServiceWithinSumRT extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSumRT() {
        super();
        queryParams.put("formid", "A-离心机体维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSumRT.class.getName()).log(Level.SEVERE, null, ex);
        }
