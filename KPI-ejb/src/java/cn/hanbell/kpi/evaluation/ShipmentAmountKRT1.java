 ...
 */
public class ShipmentAmountKRT1 extends ShipmentAmount {

    protected Actual actualInterface;

    public ShipmentAmountKRT1() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.ShipmentAmountR1B4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal hd = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.ShipmentAmountR1C4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal jn = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.ShipmentAmountR1D4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal gz = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.ShipmentAmountR1E4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal nj = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.ShipmentAmountR1V4").newInstance();
            actualInterface.setEJB(ejb);
        ...
        return shp1.subtract(bshp1).add(arm232).add(arm235).add(arm270).add(arm423).add(rt);
    }
