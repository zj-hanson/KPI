 ...
 * @author C1749
 */
public class QRAComplaintsQualityShipmentP1Z2 extends QRAComplaints{
    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public QRAComplaintsQualityShipmentP1Z2() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(QRAComplaintsQualityShipmentP1Z2.class.getName()).log(Level.SEVERE, null, ex);
        }
        return v1;
    }
