 ...
 * @author C1879
 */
public class FreeServiceWithinSum5AB extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSum5AB() {
        super();
        queryParams.put("formid", "A-柯茂维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSum5AB.class.getName()).log(Level.SEVERE, null, ex);
        }
