 ...
 * @author C1879
 */
public class FreeServiceOuterSumRT extends FreeServiceERP{

    IndicatorBean indicatorBean = lookupIndicatorBean();

    public FreeServiceOuterSumRT() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceOuterSumRT.class.getName()).log(Level.SEVERE, null, ex);
        }
