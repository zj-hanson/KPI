 ...
 * @author C1879
 */
public class FreeServiceWithinSum1H extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSum1H() {
        super();
        queryParams.put("formid", "A-真空维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSum1H.class.getName()).log(Level.SEVERE, null, ex);
        }
