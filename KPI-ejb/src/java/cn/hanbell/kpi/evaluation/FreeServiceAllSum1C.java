 ...
 * @author C1879
 */
public class FreeServiceAllSum1C extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1C() {
        super();
        queryParams.put("formid", "A-济南综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1C.class.getName()).log(Level.SEVERE, null, ex);
        }
