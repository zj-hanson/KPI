 ...
 * @author C1879
 */
public class FreeServiceAllSum1E extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1E() {
        super();
        queryParams.put("formid", "A-南京综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1E.class.getName()).log(Level.SEVERE, null, ex);
        }
