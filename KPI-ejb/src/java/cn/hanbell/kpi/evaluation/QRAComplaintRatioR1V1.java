 ...
 */
public class QRAComplaintRatioR1V1 extends QRA {
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        try {
            ...
            //CRM的制造号码在3MIS里的笔数
            Actual crm = (Actual) QRAComplaintOrderR1.class.newInstance();
            BigDecimal ev = crm.getValue(y, m, d, type, crm.getQueryParams());
            //KPI的移动平均出货台数
            Actual kpi = (Actual) QRAShipmentAvgAllR1.class.newInstance();
...
class QRAComplaintOrderR1 extends QRAComplaintOrder {

    public QRAComplaintOrderR1() {
        super();
...
class QRAShipmentAvgAllR1 extends QRAShipmentAvgAll {

    public QRAShipmentAvgAllR1() {
        super();
