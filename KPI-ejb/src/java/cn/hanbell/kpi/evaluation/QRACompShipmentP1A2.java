 ...
 * @author C1749
 */
public class QRACompShipmentP1A2 extends QRAAConnERP{
    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public QRACompShipmentP1A2() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(QRACompShipmentP1A2.class.getName()).log(Level.SEVERE, null, ex);
        }
        return v1;
    }
