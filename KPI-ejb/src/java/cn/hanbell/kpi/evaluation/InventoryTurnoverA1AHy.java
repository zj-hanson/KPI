 ...
 * @author C1749
 * @data 2020-4-1
 * @description 空压机体生产周转天数 :本月周转天数 = 今年到本月的天数 / (本月销售成本/((本月库存金额+上月库存金额)/2))
 * @description2 此指标与2020年方针目标变更 不再使用 留着做备份
 */
public class InventoryTurnoverA1AHy extends InventoryTurnoverA1 {

    public InventoryTurnoverA1AHy() {
        super();
    }
