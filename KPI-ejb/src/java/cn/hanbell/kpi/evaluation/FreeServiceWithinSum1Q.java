 ...
 * @author C1879
 */
public class FreeServiceWithinSum1Q extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSum1Q() {
        super();
        queryParams.put("formid", "A-空压机组维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSum1Q.class.getName()).log(Level.SEVERE, null, ex);
        }
