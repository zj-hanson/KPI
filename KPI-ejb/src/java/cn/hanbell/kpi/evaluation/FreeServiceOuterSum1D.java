 ...
 * @author C1879
 */
public class FreeServiceOuterSum1D extends FreeServiceERP{

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceOuterSum1D() {
        super();
        queryParams.put("formid", "A-广州服务成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceOuterSum1D.class.getName()).log(Level.SEVERE, null, ex);
        }
