 ...
 * @author C1879
 */
public class FreeServiceOuterSum1E extends FreeServiceERP{

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceOuterSum1E() {
        super();
        queryParams.put("formid", "A-南京服务成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceOuterSum1E.class.getName()).log(Level.SEVERE, null, ex);
        }
