 ...
 * @author C1879
 */
public class FreeServiceWithinSum1A extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSum1A() {
        super();
        queryParams.put("formid", "A-服务维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSum1A.class.getName()).log(Level.SEVERE, null, ex);
        }
