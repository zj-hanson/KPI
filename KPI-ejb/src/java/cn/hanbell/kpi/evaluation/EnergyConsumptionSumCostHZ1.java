 ...
 * @author C1879 枫泾一厂
 */
public class EnergyConsumptionSumCostHZ1 extends EnergyConsumptionCost {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public EnergyConsumptionSumCostHZ1() {
        super();
        queryParams.put("formid", "K-枫泾一厂能耗");
        queryParams.put("deptno", "1W000");
    }

    //得到Other1（市电）与Other2的值（光伏）
    @Override
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            v1 = BigDecimal.valueOf(a1 + a2).divide(BigDecimal.ONE, 2, RoundingMode.HALF_UP);
