 ...
 * @author C1879
 */
public class FreeServiceWithinSumSDS extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSumSDS() {
        super();
        queryParams.put("formid", "A-无油机组维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSumSDS.class.getName()).log(Level.SEVERE, null, ex);
        }
