 ...
 * @author C0160
 */
public abstract class ShipmentAmountR extends Shipment {

    public ShipmentAmountR() {
        super();
    }
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        sb.append("select isnull(sum((d.shpamts * h.ratio)/(h.taxrate + 1)),0) from cdrhad h,cdrdta d where h.facno=d.facno and h.shpno=d.shpno and h.houtsta<>'W' and h.cusno NOT IN ('SSD00107','SGD00088','SJS00254','SCQ00146')  ");
        ...
        sb.setLength(0);
        sb.append("select isnull(sum((d.bakamts * h.ratio)/(h.taxrate + 1)),0) from cdrbhad h,cdrbdta d where h.facno=d.facno and h.bakno=d.bakno and h.baksta<>'W' and h.cusno NOT IN ('SSD00107','SGD00088','SJS00254','SCQ00146') ");
        sb.append(" and d.issevdta='N' and h.facno='${facno}' and h.decode='${decode}' ");
        if (!"".equals(n_code_DA)) {
            sb.append(" and d.n_code_DA ").append(n_code_DA);
        }
        ...
        return shpqy1.subtract(bshpqy1).add(arm232).add(arm235).add(arm270).add(arm423);
    }
