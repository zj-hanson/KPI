 ...
 * 服务各区支援明细
 */
public abstract class ServiceSupportAmount extends Service {

    public ServiceSupportAmount() {
        super();
    }
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        sb.append("select isnull(sum(TC091),0) from REPTC where  TC001<>'CXWX' AND TC001 like '%FW%' ");
        //other支援其他地区
