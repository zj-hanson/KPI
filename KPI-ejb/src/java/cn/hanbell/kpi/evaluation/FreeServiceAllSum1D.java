 ...
 * @author C1879
 */
public class FreeServiceAllSum1D extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1D() {
        super();
        queryParams.put("formid", "A-广州综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1D.class.getName()).log(Level.SEVERE, null, ex);
        }
