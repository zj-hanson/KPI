 ...
 * @author C1879
 */
public class FreeServiceOuterSum5C extends FreeServiceERP{

    IndicatorBean indicatorBean = lookupIndicatorBean();

    public FreeServiceOuterSum5C() {
        super();
        queryParams.put("formid", "A-涡轮服务成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceOuterSum5C.class.getName()).log(Level.SEVERE, null, ex);
        }
