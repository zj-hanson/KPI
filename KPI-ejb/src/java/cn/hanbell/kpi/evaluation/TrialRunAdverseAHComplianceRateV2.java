 ...
 */
public class TrialRunAdverseAHComplianceRateV2 extends QRAqualified {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public TrialRunAdverseAHComplianceRateV2() {
        super();
        queryParams.put("formid", "TR-一级600能效");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(TrialRunAdverseAHComplianceRateV2.class.getName()).log(Level.SEVERE, null, ex);
        }
        return result;
    }
