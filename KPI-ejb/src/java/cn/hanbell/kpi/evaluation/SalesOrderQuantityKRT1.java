...
public class SalesOrderQuantityKRT1 extends SalesOrderQuantity {
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.SalesOrderQuantityR1C4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal jn = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.SalesOrderQuantityR1D4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal gz = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.SalesOrderQuantityR1E4").newInstance();
            actualInterface.setEJB(ejb);
            BigDecimal nj = actualInterface.getValue(y, m, d, type, actualInterface.getQueryParams());
            actualInterface = (Actual) Class.forName("cn.hanbell.kpi.evaluation.SalesOrderQuantityR1V4").newInstance();
            actualInterface.setEJB(ejb);
