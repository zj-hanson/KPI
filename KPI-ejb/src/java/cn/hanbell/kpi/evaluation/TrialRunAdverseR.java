    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        if (!"".equals(typecode)) {
            if ("RC2".equals(typecode)) {
                ...
                sb.append(" and TR_TIMES='1' ");
            }
            if ("LB".equals(typecode)) {
                sb.append(" AND (B.PRODUCTMODEL  like 'LB%' or  B.PRODUCTMODEL  like 'LT%')");
                sb.append(" and TR_TIMES='1' ");
            }
            if (!"".equals(typecode) && "RCD".equals(typecode)) {
        ...
        try {
            ...
            result = BigDecimal.valueOf(value1 / value2).divide(BigDecimal.ONE, 4, RoundingMode.HALF_UP).multiply(BigDecimal.valueOf(100));
        } catch (Exception ex) {
