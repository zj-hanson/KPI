 ...
 * @author C1879
 */
public class FreeServiceAllSum5AB extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum5AB() {
        super();
        queryParams.put("formid", "A-柯茂综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum5AB.class.getName()).log(Level.SEVERE, null, ex);
        }
