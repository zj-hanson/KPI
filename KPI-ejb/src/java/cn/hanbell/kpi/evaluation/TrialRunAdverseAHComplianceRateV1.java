 ...
 */
public class TrialRunAdverseAHComplianceRateV1 extends QRAqualified {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public TrialRunAdverseAHComplianceRateV1() {
        super();
        queryParams.put("formid", "TR-一级480能效");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(TrialRunAdverseAHComplianceRateV1.class.getName()).log(Level.SEVERE, null, ex);
        }
        return result;
    }
