 ...
 * @author C1749
 */
public class QRAComplaintsQualityShipmentP1Z1 extends QRAComplaints{
    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public QRAComplaintsQualityShipmentP1Z1() {
        super();
        queryParams.put("formid", "Q-真空泵出货");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(QRAComplaintsQualityShipmentP1Z1.class.getName()).log(Level.SEVERE, null, ex);
        }
        return v1;
    }
