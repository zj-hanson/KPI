 ...
 * @author C1879
 */
public class FreeServiceWithinSum1U extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceWithinSum1U() {
        super();
        queryParams.put("formid", "A-涡旋维修成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceWithinSum1U.class.getName()).log(Level.SEVERE, null, ex);
        }
