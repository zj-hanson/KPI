...
/**
 *
 * @author C1879 2020年4月13日方利华要求HT销售统计逻辑：
 * 柯茂销售汉钟不计入，柯茂销售其他客户计入
 */
public class ShipmentAmountKHT2 extends ShipmentAmount {

    public ShipmentAmountKHT2() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        sb.append(" and h.cusno NOT IN ('SSD00107','SGD00088','SJS00254','SCQ00146','KSH00004','KZJ00029') ");
        ...
        return shp1.subtract(bshp1).add(arm232).add(arm235).add(arm423);
    }
