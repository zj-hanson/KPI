 ...
 *
 * @author C1749
 * @description 柯茂再生在制库存金额
 */
public class InventoryAmountA1KB40OH extends InventoryAmountA1 {

    public InventoryAmountA1KB40OH() {
        super();
        queryParams.put("facno", "K");
        queryParams.put("genre", "in('WL','WC','HG','BA','HE')");
    }
