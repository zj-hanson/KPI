 ...
 * @author C1879
 */
public class FreeServiceAllSum1V extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1V() {
        super();
        queryParams.put("formid", "A-重庆综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1V.class.getName()).log(Level.SEVERE, null, ex);
        }
