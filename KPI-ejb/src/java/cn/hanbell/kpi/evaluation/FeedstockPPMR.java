...
/**
 *
 * @author C1749 PPM*1000000冷媒的
 */
public class FeedstockPPMR extends Complaints {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FeedstockPPMR() {
        super();
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        IndicatorDetail o1 = i.getOther1Indicator();//QZ不良
        IndicatorDetail o2 = i.getOther2Indicator();//QJ+QC不良
