 ...
 * @author C1879
 */
public class FreeServiceAllSum1H extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1H() {
        super();
        queryParams.put("formid", "A-真空综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1H.class.getName()).log(Level.SEVERE, null, ex);
        }
