 ...
 * @author C1879
 */
public class FreeServiceAllSum1T extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1T() {
        super();
        queryParams.put("formid", "A-国际营销综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1T.class.getName()).log(Level.SEVERE, null, ex);
        }
