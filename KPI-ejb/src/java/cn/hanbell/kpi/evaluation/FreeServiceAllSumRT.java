 ...
 * @author C1879
 */
public class FreeServiceAllSumRT extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSumRT() {
        super();
        queryParams.put("formid", "A-离心机体综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSumRT.class.getName()).log(Level.SEVERE, null, ex);
        }
