...
public class FreeServiceWithinZL1G extends FreeServiceWithinZL{
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        sb.append(" and manpid.altitnbr <> '3188-GBR6254-FW' and manpih.facno = '${facno}' and manpih.prono='1'  and (manpih.issdepno = '9900' or manpih.issdepno like '1G%') ");
        ...
        sb.append(" and manred.altitnbr <>'3188-GBR6254-FW' and manreh.facno='${facno}' and manreh.prono='1' and (manreh.retdepno='9900' or manreh.retdepno like '1G%') ");
