 ...
 * @author C1879
 */
public class FreeServiceOuterSum1H extends FreeServiceERP{

    IndicatorBean indicatorBean = lookupIndicatorBean();

    public FreeServiceOuterSum1H() {
        super();
        queryParams.put("formid", "A-真空服务成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceOuterSum1H.class.getName()).log(Level.SEVERE, null, ex);
        }
