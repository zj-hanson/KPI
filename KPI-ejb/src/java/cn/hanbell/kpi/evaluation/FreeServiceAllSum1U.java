 ...
 * @author C1879
 */
public class FreeServiceAllSum1U extends FreeServiceERP {

    IndicatorBean indicatorBean = lookupIndicatorBeanBean();

    public FreeServiceAllSum1U() {
        super();
        queryParams.put("formid", "A-涡旋综合成本");
    ...
    public BigDecimal getValue(int y, int m, Date d, int type, LinkedHashMap<String, Object> map) {
        ...
        try {
            ...
            Logger.getLogger(FreeServiceAllSum1U.class.getName()).log(Level.SEVERE, null, ex);
        }
