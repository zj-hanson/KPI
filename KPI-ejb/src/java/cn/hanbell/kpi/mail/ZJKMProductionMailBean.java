...
@Stateless
@LocalBean
public class ZJKMProductionMailBean extends BscProductiontMail {

    public ZJKMProductionMailBean() {
    ...
    protected String getMailBody() {
        indicator = indicatorBean.findByFormidYearAndDeptno("Q-浙江柯茂每日生产", y, "1N000");
        if (indicator == null) {
