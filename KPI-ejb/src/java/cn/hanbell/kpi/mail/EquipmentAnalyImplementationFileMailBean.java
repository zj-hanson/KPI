...
@Stateless
@LocalBean
public class EquipmentAnalyImplementationFileMailBean extends MailNotification {
    ...
    public EquipmentAnalyImplementationFileMailBean() {
    ...
    protected String getMailBody() throws ParseException {
        attachments.clear();
        String fileName = "自主保全实施表" + BaseLib.formatDate("yyyyMMddHHmmss", BaseLib.getDate()) + ".xls";
        ...
        try {
            ...
            String path = "../" + strDate + "自主点检实施表.xls";//新建文件保存路径
