...
@Stateless
@LocalBean
public class SProductionMailBean extends BscProductiontMail {

    public SProductionMailBean() {
    ...
    protected String getMailBody() {
        indicator = indicatorBean.findByFormidYearAndDeptno("Q-S涡旋每日生产", y, "1N000");
        if (indicator == null) {
