...
@Stateless
@LocalBean
public class PR600ProductionMailBean extends BscProductiontMail {

    public PR600ProductionMailBean() {
    ...
    protected String getMailBody() {
        indicator = indicatorBean.findByFormidYearAndDeptno("Q-PR600每日生产", y, "1N000");
        if (indicator == null) {
