...
@Stateless
@LocalBean
public class PJZPorductionMailBean extends BscProductiontMail {

    public PJZPorductionMailBean() {
    ...
    protected String getMailBody() {
        indicator = indicatorBean.findByFormidYearAndDeptno("Q-P机组每日生产", y, "1P000");
        if (indicator == null) {
