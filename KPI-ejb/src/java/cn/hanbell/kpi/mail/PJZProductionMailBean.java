...
@Stateless
@LocalBean
public class PJZProductionMailBean extends BscProductiontMail {

    public PJZProductionMailBean() {
    ...
    protected String getMailBody() {
        indicator = indicatorBean.findByFormidYearAndDeptno("Q-P机组每日生产", y, "1N000");
        if (indicator == null) {
