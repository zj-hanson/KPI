 ...
 * @author C1879
 */
@ManagedBean(name = "inventoryAmount1NReportBean")
@ViewScoped
public class InventoryAmount1NReportBean extends BscSheetManagedBean {

    public InventoryAmount1NReportBean() {
    }
        ...
        for (Indicator indicator1 : indicatorList) {
            ...
            for (Indicator e : list) {
                ...
                try {
                    ...
                    Logger.getLogger("inventoryAmount1NReportBean").log(Level.SEVERE, null, ex);
                }
