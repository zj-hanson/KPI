 ...
 * @author C1879
 */
@ManagedBean(name = "inventoryAmount1ReportBean")
@ViewScoped
public class InventoryAmount1ReportBean extends BscSheetManagedBean {

    public InventoryAmount1ReportBean() {
    }
...
//        indicatorDetailList.add(sumBG);
    ...
    public String percentFormat(BigDecimal value, int i) {
        if (value == null) {
            ...
            return "";
        } else if (value.compareTo(BigDecimal.valueOf(100.00)) == 0 && i > m ) {
            return "";
        }  
        else {
            return indicatorBean.percentFormat(value);
