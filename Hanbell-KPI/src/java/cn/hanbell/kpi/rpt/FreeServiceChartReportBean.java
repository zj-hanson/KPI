 ...
 * @author C0160
 */
@ManagedBean(name = "freeServiceChartReportBean")
@ViewScoped
public class FreeServiceChartReportBean extends BscChartManagedBean {

    /**
     * Creates a new instance of ShipmentReportBean
     */
    public FreeServiceChartReportBean() {
    ...
    public void init() {
        ...
        try {
            for (int i = 1; i <= getM(); i++) {
                ...
                //累计控制
                v = indicatorBean.getAccumulatedPerformance(indicator.getTargetIndicator(), indicator.getActualIndicator(), i);
