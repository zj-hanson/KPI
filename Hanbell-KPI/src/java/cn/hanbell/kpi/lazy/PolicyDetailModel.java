...
public class PolicyDetailModel extends BaseLazyModel<PolicyDetail> {
    ...
    public PolicyDetailModel(SuperEJB superEJB, UserManagedBean userManagedBean) {
        this.superEJB = superEJB;
        this.userManagedBean = userManagedBean;
    }

    @Override
    public List<PolicyDetail> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, Object> filters) {
